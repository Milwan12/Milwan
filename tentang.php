...
<?php include'header.php'; ?>
 ...
 <title>Portofolio Muhammad Milwan Kurniawan</title>
						...
						<div class="story-content">
							...
							<div class="single-story">
								...
								<div class="inner-content wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
									<h4>Nama : Muhammad Milwan Kurniawan</h4>
								</div>
							</div>
							<div class="single-story">
							...
							<div class="single-story">
								...
								<div class="inner-content wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
									<h4>Pendidikan Terakhir : SMA/MA/Sederajat</h4>
								</div>
							</div>
							<div class="single-story">
								<span class="year wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.4s">6.</span>
								<div class="inner-content wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
									<h4>Alamat : Jl. Kyai Wanda Krajan Lor, RT 003/002 Desa Kaliwadas Kec. Bumiayu, Kab. Brebes. (52273)</h4>
								</div>
							</div>
							...
							<div class="single-story">
								...
								<div class="inner-content wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
									<h4>No. HandPhone : 0813 9164 4785</h4>
								</div>
							</div>
							<div class="single-story">
								<span class="year wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.4s">8.</span>
								<div class="inner-content wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
									<h4>Email : milwanpercussion1207@gmail.com</h4>
								</div>
							</div>

							<div class="single-story">
								<span class="year wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.4s">9.</span>
								<div class="inner-content wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
									<h4>Web Site : milwan-kurniawan.vercel.app</h4>
								</div>
							</div>
